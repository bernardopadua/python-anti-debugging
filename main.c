...
unsigned short original = 0x618A;
unsigned short edited;
...
int main()
{
    ...
    edited = CRCCCITT((unsigned char *)&doEverything, (DWORD)&CRCCCITT-(DWORD)&doEverything-1, 0xffff, 0);
    printf("Edited Hash: %02X\n\n", edited);
